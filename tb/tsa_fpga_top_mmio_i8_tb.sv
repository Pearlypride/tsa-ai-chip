...
module tsa_fpga_top_mmio_i8_tb;
    ...
    initial begin
        $dumpfile("waves/tsa_fpga_top_mmio_i8.vcd");
        $dumpvars(0, tsa_fpga_top_mmio_i8_tb);

        csv_fd = $fopen("reports/tsa_fpga_mmio_timeline.csv", "w");
        ...
        $display("TSA-1 FPGA MMIO TOP test started");
        ...
        // Poll STATUS until valid bit 2 = 1
        rdata = 0;
        while (rdata[2] == 1'b0) begin
